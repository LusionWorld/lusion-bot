  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="flex w-full max-w-sm flex-col items-center text-center">
        <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl border border-border bg-surface text-2xl font-semibold text-accent">
          L
        </div>

        <h1 className="text-xl font-semibold text-text">Painel Lusion</h1>
        <p className="mt-2 text-sm text-text-muted">
          Entre com sua conta Discord para gerenciar os servidores onde você é administrador.
        </p>

        {searchParams.error && (
          <p className="mt-4 rounded-lg border border-danger/30 bg-danger-muted px-3 py-2 text-sm text-danger">
        ...
        <a
          href="/api/auth/login"
          className="mt-8 flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-accent-hover"
        >
          <DiscordMark />
          Entrar com Discord
        </a>
